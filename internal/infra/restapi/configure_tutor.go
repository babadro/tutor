...
func configureAPI(api *operations.TutorAPI) http.Handler {
	...
	if api.PostChatHandler == nil {
		api.PostChatHandler = operations.PostChatHandlerFunc(func(params operations.PostChatParams) middleware.Responder {
			return middleware.NotImplemented("operation operations.PostChat has not yet been implemented")
		})
	}
